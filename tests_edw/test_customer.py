...
from edw.rest.auth import PasswordResetSerializer
from edw.models.defaults.customer import Customer
from edw.middleware import CustomerMiddleware
from edw.models.customer import VisitingCustomer, CustomerManager
...
class PasswordResetSerializerTest(TestCase):
    ...
    def test_save(self):
        ...
        serializer.reset_form.save.assert_called_with(
            ...
            request=request,
            subject_template_name=u'edw/email/reset-password-subject.txt',
            email_template_name='edw/email/reset-password-body.txt',
        )
