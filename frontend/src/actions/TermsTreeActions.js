...
export const getTermsTree = (type, mart_id, selected = []) => dispatch => {
...
export const toggleTerm = (term = {}) => dispatch => {
  dispatch({type: TOGGLE_TERM, term});
};


export const resetTerm = (term = {}) => dispatch => {
  dispatch({type: RESET_TERM, term});
};

export const resetBranch = (term = {}) => dispatch => {
  dispatch({type: RESET_BRANCH, term});
};


export const showInfo = (term = {}) => dispatch => {
  dispatch({type: SHOW_INFO, term});
};


export const hideInfo = (term = {}) => dispatch => {
  dispatch({type: HIDE_INFO, term});
};
