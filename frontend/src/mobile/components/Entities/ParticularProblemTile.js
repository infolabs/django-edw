...
export default class ParticularProblemTile extends EntityMixin(Component) {
    ...
    return (
      <ScrollView scrollEventThrottle={2000}
        ...
        <Layout style={styles.layout}>
          {items.map(
            (child, i) => <ParticularProblemTileItem key={i} data={child} domain={instance.Domain} getEntity={getEntity}
