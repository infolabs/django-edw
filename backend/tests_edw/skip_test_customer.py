...
to represent edw customers; for (django-)registered customers, a
...
from edw.models.customer import CustomerModel as Customer, SESSION_KEY
...
class CustomerTest(TestCase):
    ...
    def test_swap_customer_on_login(self):
        ...
        deleted.
        """
        request = self.factory.post('/edw/auth/login/', follow=True)
        request.user = self.bart
