...
class PolymorphicEntityProductMetaclass(PolymorphicEntityMetaclass, PolymorphicProductMetaclass):
    pass


class BaseEntityProductManager(BaseEntityManager, BaseProductManager):
    pass
'''


@python_2_unicode_compatible
#class SmartCard(six.with_metaclass(PolymorphicEntityProductMetaclass, BaseEntity, BaseProduct)):
