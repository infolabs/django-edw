...
class ManyToManyField(DeferredRelatedField):
    ...
    def __init__(self, to, **kwargs):
        ...
        if through is None or not through._meta.abstract:
...
class ForeignKeyBuilder(ModelBase):
    ...
    an abstract Model class. In Django-EDW this limitation is circumvented by creating deferred
    ...
    EDW_APP_LABEL = 'myedw'
    so that the models are created inside your own edw instantiation.
    """
