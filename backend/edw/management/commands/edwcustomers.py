...
class Command(BaseCommand):
    help = _("Collect information about all customers which accessed this EDW.")
    ...
    def handle(self, verbosity, delete_expired, *args, **options):
        ...
        for customer in CustomerModel.objects.iterator():
            ...
            if customer.is_expired():
                ...
                if delete_expired:
                    customer.delete()
        msg = _("Customers in this EDW: total={total}, anonymous={anonymous}, expired={expired}, active={active}, guests={guests}, registered={registered}, staff={staff}.")
